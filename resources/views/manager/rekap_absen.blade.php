        ...
        <div class="row">
            <div class="col-12 col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <form action="/cari-nama-staff" method="post">
                            @csrf
                            <div class="row">
                                <div class="input-group mb-3">
                                    <label class="input-group-text" for="">Nama</label>
                                    <select class="form-select" id="" name="nama">
                                    <option selected disabled>-- Pilih Nama Staff --</option>
            ...
            <div class="col-12 col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <div class="row">
                            <form action="cari-tanggal-staff" method="post">
                            @csrf
                            <div class="input-group mb-3">
            ...
            <div class="col-12 col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="row">
                            <button type="submit" disabled class="btn btn-info" data-toggle="modal" data-target="#defaultModalPrimary"><li class="fas fa-search"></li> Cari Data</button>
                        </form>
                        </div>
                    </div>
                </div>
