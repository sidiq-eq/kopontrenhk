	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar">
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand" href="{{url('/beranda4')}}">
          <span class="align-middle">Kopontren HK</span>
				...
				<ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
						<a class="sidebar-link" href="{{url('/beranda4')}}">
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="{{url('/cek-data')}}">
							<i class="fab fa-wpforms"></i> <span class="align-middle">Laporan Semua Data</span>
            			</a>
