            ...
            <div class="col-12 col-xl-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @endif
                        <h5 class="card-title">Berikut data absen atas nama : </h5>
                        <h6 class="card-subtitle text-muted">dengan parameter Nama Unit : {{$unit}} bulan : {{$bulan}} tahun : {{$tahun}} </h6>
                    </div>
                    <div class="row">
                        <div class="container">
                            <a class="btn btn-info btn-sm" href="{{url('/cek-data')}}"><i class="fa fa-arrow-left"></i> Back</a>
                                ...
                                <form action="/export-unit" method="post" style="display: inline">
                                    @csrf
