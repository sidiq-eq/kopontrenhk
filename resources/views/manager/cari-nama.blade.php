...
@section('title','Cari Absen Staff')
@section('main')
<main class="content">
            ...
            <div class="col-12 col-xl-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h6 class="card-subtitle text-muted">dengan parameter Nama Karyawan : {{str_replace('"','',$nama)}} bulan : {{$bulan}} tahun : {{$tahun}} </h6>
                    </div>
                    <div class="row">
                        <div class="container">
                            <a class="btn btn-info btn-sm" href="{{url('/rekap-absen')}}"><i class="fa fa-arrow-left"></i> Back</a>
                                <button class="btn btn-primary btn-sm" onclick="printDiv('printableArea')"><i class="fa fa-print"></i> Print</button>
                                <form action="/export-nama" method="post" style="display: inline">
                                    @csrf
                            ...
                            @foreach ($data_absen as $absen)
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                            ...
                                            <td nowrap><li class="fas fa-arrow-circle-down alert-success"></li>
