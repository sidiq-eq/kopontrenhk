...
<main class="content">
    <div class="container-fluid p-0" id="printableArea">
        ...
        <h1 class="h3 mb-3">Data Absen {{$nama[0]}}</h1>
        <div class="row">
            <div class="container">
            ...
            <div class="col-12 col-xl-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @endif
                        <h5 class="card-title">Berikut data absen atas nama : {{$nama[0]}}</h5>
                        <h6 class="card-subtitle text-muted">dengan parameter nama : {{$nama[0]}}, Tanggal : {{$date[0]}} </h6>
                    </div>
                    <div class="row">
                        <div class="container">
