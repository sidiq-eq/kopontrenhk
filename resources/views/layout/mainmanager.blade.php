	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar">
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand" href="{{url('/beranda3')}}">
          <span class="align-middle">Kopontren HK</span>
				...
				<ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
						<a class="sidebar-link" href="{{url('/beranda3')}}">
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="{{url('/form-pendapatan')}}">
							<i class="fab fa-wpforms"></i> <span class="align-middle">Form Laporan Kasa</span>
            			</a>
						<a class="sidebar-link" href="{{url('/form-konsinyasi')}}">
							<i class="fab fa-wpforms"></i> <span class="align-middle">Form Laporan Konsinyasi</span>
            			</a>
						
						<a class="sidebar-link" href="{{url('/detail-pendapatan')}}">
							<i class="fas fa-money-check-alt"></i> <span class="align-middle">Data Seluruh Laporan</span>
            			</a>
						<a class="sidebar-link" href="{{url('/karyawan-manager')}}">
							<i class="fas fa-user"></i> <span class="align-middle">Staff Unit</span>
            			</a>
					</li>
                    <li class="sidebar-header">
						Absensi
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="{{url('/rekap-absen')}}">
