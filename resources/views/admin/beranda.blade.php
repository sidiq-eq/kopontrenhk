                ...
                <div class="w-100">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="mt-1 mb-3 text-secondary"><li class="fas fa-user"></li>admin</h3>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title mb-4">Buat Laporan Absen</h5>
                                    
                                    
                                    <h3 class="mt-1 mb-3"><a href="{{url('list_absen')}}" class="text-success"><li class="fas fa-arrow-circle-right"></li> Menu Absensi</a></h3>
                                    
                                    <div class="mb-1">
                                        <span class="text-muted">Shortcut ke Menu Absensi</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title mb-4">Buat Slip Penggajian</h5>
                ...
                <div class="card flex-fill">
                    ...
                    <table id="tabel3" class="table table-responsive table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td nowrap>{{$tgl}}</td>
                                <td class="alert-info" nowrap><b>{{$data->id_unit}}</b></td>
                                <td class="alert-info" nowrap><b>{{$total}}</b></td>
